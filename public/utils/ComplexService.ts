...
export class ComplexService {
    static async getComplexNames(): Promise<ComplexName[]> {
        try {
    ...
    static async getComplexes(params: Record<string, any> = {}): Promise<ComplexesResponse> {
        try {
    ...
    static async searchComplexes(searchTerm: string): Promise<ComplexName[]> {
        try {
