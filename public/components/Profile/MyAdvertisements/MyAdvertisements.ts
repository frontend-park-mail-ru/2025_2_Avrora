...
export class MyAdvertisements {
    ...
    async render(): Promise<HTMLElement> {
        ...
        try {
            ...
            console.log('Loaded my offers:', this.offers);
    ...
    createAd(offerData: OfferData): HTMLElement {
        const ad = document.createElement("div");
        ad.className = "profile__ad";
        ad.dataset.offerId = String(offerData.id);
        ...
        ad.addEventListener('click', (e: Event) => {
            const target = e.target as Element;
            if (!target.closest('.profile__ad-actions')) {
    ...
    async handleDeleteOffer(offerId: number): Promise<void> {
        try {
