...
// OfferCreateFifthStage.js - добавьте в метод handleFileUpload
...
// Добавьте метод для проверки минимального количества изображений
validateImages() {
    ...
    restoreFormData() {
        ...
        if (currentData.images && currentData.images.length > 0) {
            ...
            this.images = currentData.images.map(img => ({
                filename: img.filename,
