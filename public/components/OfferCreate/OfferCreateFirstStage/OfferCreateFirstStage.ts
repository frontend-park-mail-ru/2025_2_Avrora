// OfferCreateFirstStage.ts
interface OfferCreateFirstStageParams {
    state?: any;
    app?: any;
    dataManager?: any;
    isEditing?: boolean;
...
export class OfferCreateFirstStage {
    ...
    constructor({ state, app, dataManager, isEditing = false, editOfferId = null }: OfferCreateFirstStageParams = {}) {
        this.state = state;
        this.app = app;
    ...
    createNav({ prev = false, next = false, publish = false }: NavOptions = {}): HTMLElement {
